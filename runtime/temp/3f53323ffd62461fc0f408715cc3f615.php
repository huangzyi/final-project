<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"/Users/zyh/apache/thinkphp/public/../app/admin/view/index/finduser.html";i:1559140534;s:62:"/Users/zyh/apache/thinkphp/app/admin/view/common/vertical.html";i:1559995409;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
	<meta charset="UTF-8">
		...
		<form id="msform" action="/thinkphp/public/admin/index/addfriend" method="post" >
			...
			<fieldset>
				...
				<div class="div-search" style="padding-top: 20px" >
					...
					<input type="text" class="search-box" id = "search" name="s" style="border: 1px solid #ccc">
				...
				<div class="group-menu">
					...
					<table class="table table-condensed table-hover table-bordered">
						...
						<tr class="dataRow">
							...
							<td><?php echo $f['user_uname']; ?></td>
							<td><?php echo $f['user_name']; ?></td>
							<td><?php echo $f['user_age']; ?></td>
							<td><?php echo $f['user_sex']; ?></td>
							<td><?php echo $f['user_city']; ?></td>
							<td><button type="button" class="btn btn-success btn-xs" onclick="window.location.href='information?user_id=<?php echo $f['user_id']; ?>'"> 详情</button></td>
						</tr>
