<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"/Users/zyh/apache/thinkphp/public/../app/index/view/index/showmerchant.html";i:1558148041;s:62:"/Users/zyh/apache/thinkphp/app/index/view/common/vertical.html";i:1558062664;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
	<meta charset="UTF-8">
...
<style type="text/css">
	*{
	...
	<form id="merform"  style="" action="/thinkphp/public/index/index/showmerchant" method="post">
		<!-- fieldsets -->
		<fieldset>
			<a class="close" onclick="close()"><i class="fa fa-close"></i></a>
			<h2 class="text-primary" style="display: none;">娱乐项目选择</h2>
			<input style="display: none" value="<?php echo $user->user_id; ?>" name = "user_id">
			...
			<div class="div-favorite">
				...
				<button class="btn btn-success btn-xs" onclick="javascrtpt:window.location.href='../showmerchant?user_id=<?php echo $user->user_id; ?>&favor=1'" >收藏夹</button>
				...
				<li class="list-group-item">
					<div data-poiid="2" data-cateid="1"  >
						...
						<div class="default-card">
							...
							<div class="i-div">
								<p><a class="i-left favorite" href="/thinkphp/public/index/favorite/favorite?user_id=<?php echo $user->user_id; ?>&merchant_id=<?php echo $m['merchant_id']; ?>"><i class="fa fa-star-o"></i></a>
							...
							<div class="div-choose" style="display: block">
								...
								<input type="button" class="btn-primary btn-ms"
									   ...
									   onclick="return getchooseid('<?php echo $m['merchant_id']; ?>')" value="选择">
							</div>
						</div>
					</div>
				</li>
