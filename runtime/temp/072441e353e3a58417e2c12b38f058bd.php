<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"/Users/zyh/apache/thinkphp/public/../app/admin/view/index/schedule.html";i:1559144968;s:62:"/Users/zyh/apache/thinkphp/app/admin/view/common/vertical.html";i:1559136704;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
	<meta charset="UTF-8">
...
<style type="text/css">
	*{
	...
	<article class="htmleaf-content" >
		...
		<!-- multistep form -->
		<form id="msform" action="/thinkphp/public/admin/addparty/addparty" method="post">
			<!-- fieldsets -->
			<fieldset>
				<ul class="list-group">
					<li class="list-group-item">
						<label class="text-info lab-list-name">id</label>
						<input type="text" name="schedule_id" value="<?php echo $schedule->schedule_id; ?>"id="id" placeholder="schedule_id"/>
					</li>
					<li class="list-group-item">
						<label class="text-info lab-list-name">方案名</label>
						<input type="text" name="schedule_name" value="<?php echo $schedule->schedule_name; ?>"id="name" placeholder="name"/>
					</li>
					<li class="list-group-item">
						<label class="text-info lab-list-name">创建者</label>
						<input type="text" name="schedule_founder"value="<?php echo $schedule->schedule_founder; ?>" id="founder" placeholder="founder"/>
					</li>
					<li class="list-group-item">
						<label class="text-info lab-list-name">时间</label>
						<input type="text" name="schedule_time" value="<?php echo $schedule->schedule_time; ?>"id="flatpickr-tryme" placeholder="请选择日期"/>
					</li>
					<li class="list-group-item">
						<label class="text-info lab-list-name">城市</label>
						<input type="text" name="city" value="<?php echo $schedule->city; ?>" id="city" placeholder="城市"/>
					</li>
					<li class="list-group-item">
						<label class="text-info lab-list-name">人数</label>
						<input type="text" name="schedule_number"value="<?php echo $schedule->schedule_number; ?>" id="number" placeholder="人数"/>
					</li>
					<li class="list-group-item">
						<label class="text-info lab-list-name">上午</label>
						<input type="text " value="<?php echo $schedule->schedule_morning; ?>"name="schedule_morning" id="morning"
							   placeholder="上午"   />

					</li>
					<li class="list-group-item">
						<label class="text-info lab-list-name">中饭</label>
						<input type="text" value="<?php echo $schedule->schedule_noon; ?>"name="schedule_noon" id="noon"
							   placeholder="中餐"   />

					</li>
					<li class="list-group-item">
						<label class="text-info lab-list-name">下午</label>
						<input type="text" value="<?php echo $schedule->schedule_afternoon; ?>"name="schedule_afternoon" id="afternoon"
							   placeholder="下午"   />
					...
					<li class="list-group-item">
						...
						<input type="text" value="<?php echo $schedule->schedule_dinner; ?>"name="schedule_dinner" id="dinner"
							   placeholder="晚餐"   />


					</li>
				</ul>
				<input type="button" name="button" class="submit action-button" onclick="window.location.href='/thinkphp/public/admin/addparty/del?schedule_id=<?php echo $schedule['schedule_id']; ?>'" value="删除" />
				<input type="button"  id="btn-clear" class="action-button"  value="清空"  />
				<input type="submit" name="submit" class="submit action-button" value="修改" />
