<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"/Users/zyh/apache/thinkphp/public/../app/admin/view/index/choosefriend.html";i:1558262257;s:62:"/Users/zyh/apache/thinkphp/app/admin/view/common/vertical.html";i:1559132705;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
	<meta charset="UTF-8">
...
<!--<h1 >分享<span style="color: #eee">选择好友或组群进行分享吧 </span> </h1>-->


<!--</header>-->
<form>
<div class="htmleaf-container friend-container navbar-fixed-top" >
	<button class="btn btn-primary btn-friendlist" type="button" onclick="javascript:window.history.back(-1);">返回</button>
	<div class="content">
			...
			<ul>
				...
				<li><a href="#"><i class="fa fa-user"></i>好友 </a>
					<ul class="submenu" id="friend">
						...
						<!--<li><a href="#"></a></li>-->
						<li>
							<a href="<?php echo $url; ?>type=friend&link_id=<?php echo $f->link_id; ?>">
				...
				<li><a href="#"><i class="fa fa-users"></i>群组 </a>
					<ul class="submenu" id="group">
						...
						<!--<li><a href="#"></a></li>-->
						<li>
							<a href="<?php echo $url; ?>type=group&link_id=<?php echo $g->group_id; ?>">
								<!--<input type="checkbox" name="friend_id" value="" style="width: 20px">-->
