<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"/Users/zyh/apache/thinkphp/public/../app/index/view/index/addfriend.html";i:1559182949;s:62:"/Users/zyh/apache/thinkphp/app/index/view/common/vertical.html";i:1558062664;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
	<meta charset="UTF-8">
...
<style type="text/css">
	*{
	...
	<article class="htmleaf-content" >
		<!-- multistep form -->
		<form id="msform" action="/thinkphp/public/index/index/addfriend" method="post" >
			<!-- fieldsets -->
			<fieldset>
				<div class="div-search" style="padding-top: 20px" >
				<input type="text" class="search-box" id = "search" name="s"placeholder="请输入用户id或姓名" style="border: 1px solid #ccc">
				...
				<div class="group-menu">
					...
					<table class="table table-condensed table-hover table-bordered">
						...
						<tr class="dataRow">
							...
							<td><?php echo $f['user_age']; ?></td>
							<td><?php echo $f['user_sex']; ?></td>
							<td><?php echo $f['user_city']; ?></td>
							<td><button type="button" class="btn btn-success btn-xs" onclick="window.location.href='/thinkphp/public/index/Addfriend/add?user_id=<?php echo $f['user_id']; ?>'"> 添加</button></td>
						</tr>
