<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"/Users/zyh/apache/thinkphp/public/../app/index/view/index/dialog.html";i:1558713452;s:62:"/Users/zyh/apache/thinkphp/app/index/view/common/vertical.html";i:1558062664;s:59:"/Users/zyh/apache/thinkphp/app/index/view/index/friend.html";i:1558267756;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
	<meta charset="UTF-8">
	...
	<title>约吧-和<?php echo $dialog_name; ?>的对话</title>
...
<div class="dialog-container">
	<form role="form" action="/thinkphp/public/index/message/send" method="post">
		<div class="form-group">
			<div class="form-title">
				<div class="dropdown btn-friendother">
					...
					<ul class="dropdown-content">
						<li>
							<?php if($type == 'friend'): ?>
							<a href="friendinformation.html?user_id=<?php echo $friend_id; ?>">好友信息</a>
							<?php else: ?>
				...
				<label class="text-info dialog-friendname" style="text-align:center"><?php echo $dialog_name; ?></label>
