<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"/Users/zyh/apache/thinkphp/public/../app/index/view/index/show.html";i:1559183210;s:62:"/Users/zyh/apache/thinkphp/app/index/view/common/vertical.html";i:1558062664;s:62:"/Users/zyh/apache/thinkphp/app/index/view/common/merchant.html";i:1559111839;s:60:"/Users/zyh/apache/thinkphp/app/index/view/common/search.html";i:1559111910;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
	<meta charset="UTF-8">
					...
					<li class="list-group-item" style="height: auto">
						<div data-poiid="2" data-cateid="1"  >
									...
									<div class="list-item-desc">
										...
										<?php if($type != 'favor'): ?>
										<div class="i-div" >
											<p><a class="i-left" href="/thinkphp/public/index/share/comment?type=<?php echo $type; ?>&merchant_id=<?php echo $m->merchant_id; ?>&link_id=<?php echo $link_id; ?>&share_founder=<?php echo $m->share_founder_id; ?>&comment_type=share_up"><i class="fa fa-thumbs-o-up"></i><span><?php echo $m->share_up; ?></span></a>
												<a class="i-right" href="/thinkphp/public/index/share/comment?type=<?php echo $type; ?>&merchant_id=<?php echo $m->merchant_id; ?>&link_id=<?php echo $link_id; ?>&share_founder=<?php echo $m->share_founder_id; ?>&comment_type=share_down" ><i class="fa fa-thumbs-o-down"></i><span><?php echo $m->share_down; ?></span></a></p>
										</div>
										<?php endif; ?>
										<div class="i-div" >
											<p><a class="i-left favorite" href="/thinkphp/public/index/favorite/favorite?merchant_id=<?php echo $m['merchant_id']; ?>"><i class="fa fa-star-o"></i></a>
												<a class="i-right"href="choosefriend.html?merchant_id=<?php echo $m['merchant_id']; ?>"> <i class="fa fa-share"></i></a></p>
										</div>
										<?php if($type != 'favor'): if($id == $m->share_founder_id): ?>
										<div class="div-choose"style="display: block;height: 50px" >
											...
											<input type="button" class="action-button btn-ms"
												   ...
												   onclick="window.location.href='/thinkphp/public/index/share/del?type=<?php echo $type; ?>&merchant_id=<?php echo $m->merchant_id; ?>&link_id=<?php echo $link_id; ?>'" value="取消分享">
...
<body>
		              ...
		              <div class="card-infos">
		                ...
		                <p class="card__text">
						 ...
						 <?php else: ?>
						  ...
						  <?php if($type != 'favor'): ?>
						  <h5><a class="i-left" href="/thinkphp/public/index/share/comment?type=<?php echo $type; ?>&schedule_id=<?php echo $vo->schedule_id; ?>&link_id=<?php echo $link_id; ?>&share_founder=<?php echo $vo->share_founder_id; ?>&comment_type=share_up"><i class="fa fa-thumbs-o-up"></i><span><?php echo $vo->share_up; ?></span></a>
							  <a class="i-right" href="/thinkphp/public/index/share/comment?type=<?php echo $type; ?>&schedule_id=<?php echo $vo->schedule_id; ?>&link_id=<?php echo $link_id; ?>&share_founder=<?php echo $vo->share_founder_id; ?>&comment_type=share_down"><i class="fa fa-thumbs-o-down"></i><span><?php echo $vo->share_down; ?></span></a></h5>
						  <h1> </h1>
						  <?php endif; ?>
						  <h5><a class="i-left" href="/thinkphp/public/index/favorite/favorite?schedule_id=<?php echo $vo->schedule_id; ?>"><i class="fa fa-star-o" ></i></a>
							  <a class="i-right" href="choosefriend.html?schedule_id=<?php echo $vo->schedule_id; ?>"><i class="fa fa-share"></i></a></h5>
						  <h4><button class="btn btn-success" type="button" onclick="window.location.href='showschedule?schedule_id=<?php echo $vo->schedule_id; ?>'">查看详情</button>
						  </h4>
						  <?php if($type != 'favor'): if($id == $vo->share_founder_id): ?>
						  <h4><button class="btn btn-success" type="button" onclick="window.location.href='/thinkphp/public/index/share/del?type=<?php echo $type; ?>&schedule_id=<?php echo $vo->schedule_id; ?>&link_id=<?php echo $link_id; ?>'">取消分享</button></h4>
						  <?php endif; endif; ?>
						  </p>
		              </div>
		            </div>
	...
	<script type="text/javascript">
	 ...
	 <script>
 		var favorite = false;
		function checkboxOnclick(checkbox){
 			if ( checkbox.id=='favorite'&&checkbox.checked == true){
 			favorite=true;
			}else if ( checkbox.id=='favorite'&&checkbox.checked == false){
 			favorite=false;
 			}
 		}
	</script>
